...
function(e, t, n) {
    ...
    function(n, o) {
        ...
        function d() { (ye.addEventListener || "load" === event.type || "complete" === ye.readyState) && (l(), ce.ready())
        }
        function f(e, t, n) {
        ...
        function h(e, t, n, i) {
            if (ce.acceptData(e)) {
                ...
                c = s ? ce.cache: e,
                u = s ? e[a] : e[a] && a;
                if (u && c[u] && (i || c[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[a] = K.pop() || ce.guid++:a),
                c[u] || (c[u] = s ? {}: {
                    toJSON: ce.noop
                }),
                ("object" == typeof t || "function" == typeof t) && (i ? c[u] = ce.extend(c[u], t) : c[u].data = ce.extend(c[u].data, t)),
                o = c[u],
        ...
        function N(e, t) {
            ...
            i.style && (o[a] = ce._data(i, "olddisplay"), n = i.style.display, t ? (o[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ne(i) && (o[a] = ce._data(i, "olddisplay", A(i.nodeName)))) : (r = Ne(i), (n && "none" !== n || !r) && ce._data(i, "olddisplay", r ? n: ce.css(i, "display"))));
            for (a = 0; s > a; a++) i = e[a],
        ...
        function j(e, t, n, i, r) {
            for (var o = n === (i ? "border": "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)"margin" === n && (a += ce.css(e, n + Me[o], !0, r)),
            i ? ("content" === n && (a -= ce.css(e, "padding" + Me[o], !0, r)), "margin" !== n && (a -= ce.css(e, "border" + Me[o] + "Width", !0, r))) : (a += ce.css(e, "padding" + Me[o], !0, r), "padding" !== n && (a += ce.css(e, "border" + Me[o] + "Width", !0, r)));
            return a
        }
        function D(e, t, n) {
            var i = !0,
        ...
        function H(e, t, n) {
            ...
            1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [p.overflow, p.overflowX, p.overflowY], u = ce.css(e, "display"), l = "none" === u ? ce._data(e, "olddisplay") || A(e.nodeName) : u, "inline" === l && "none" === ce.css(e, "float") && (ae.inlineBlockNeedsLayout && "inline" !== A(e.nodeName) ? p.zoom = 1 : p.display = "inline-block")),
        ...
        function F(e, t, n) {
            ...
            l = u.props;
            for (U(l, u.opts.specialEasing); a > o; o++) if (i = Ct[o].call(u, e, l, u.opts)) return i;
            return ce.map(l, P, u),
        ...
        ce.extend = ce.fn.extend = function() {
            ...
            n = r[i],
            a !== n && (u && n && (ce.isPlainObject(n) || (t = ce.isArray(n))) ? (t ? (t = !1, o = e && ce.isArray(e) ? e: []) : o = e && ce.isPlainObject(e) ? e: {},
            a[i] = ce.extend(u, o, n)) : void 0 !== n && (a[i] = n));
            return a
        },
        ce.extend({
        ...
        var pe = function(e) {
            ...
            function v(e, t, n, r, o, a) {
                ...
                i(function(i, a, s, c) {
                    ...
                    b = n ? o || (i ? e: h || r) ? [] : a: y;
                    if (n && n(y, b, s, c), r) for (u = m(b, p), r(u, [], s, c), l = u.length; l--;)(d = u[l]) && (b[p[l]] = !(y[p[l]] = d));
                    if (i) {
                        if (o || e) {
                            if (o) {
            ...
            function y(e) {
                ...
                a, !0), l = [function(e, n, i) {
                    ...
                    return t = null,
                    r
                }]; r > s; s++) if (n = C.relative[e[s].type]) l = [p(h(l), n)];
                else {
            ...
            function b(e, n) {
                ...
                a = function(i, a, s, c, u) {
                    ...
                    if (p += h, r && h !== p) {
                        ...
                        K.apply(c, v),
                        u && !i && v.length > 0 && p + n.length > 1 && t.uniqueSort(c)
                    }
                    return u && (U = w, I = y),
                    g
                };
            ...
            M = t.setDocument = function(e) {
                ...
                B = [], D = [], (x.qsa = ve.test(i.querySelectorAll)) && (r(function(e) {
                    $.appendChild(e).innerHTML = "<a id='" + P + "'></a><select id='" + P + "-\f]' msallowcapture=''><option selected=''></option></select>",
                    ...
                    O.call(e, "[s!='']:x"),
                    B.push("!=", ae)
                }), D = D.length && new RegExp(D.join("|")), B = B.length && new RegExp(B.join("|")), t = ve.test($.compareDocumentPosition), R = t || ve.test($.contains) ?
                function(e, t) {
            ...
            t.attr = function(e, t) { (e.ownerDocument || e) !== N && M(e);
                        ...
                        function(e) {
                            ...
                            if (m) {
                                ...
                                if (h = [a ? m.firstChild: m.lastChild], a && y) {
                                    for (l = m[P] || (m[P] = {}), u = l[e] || [], p = u[0] === U && u[1], f = u[0] === U && u[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (f = p = 0) || h.pop();) if (1 === d.nodeType && ++f && d === t) {
                                        l[e] = [U, p, f];
                                        break
                                    }
            ...
            E = t.tokenize = function(e, n) {
                ...
                for (s = e, c = [], u = C.preFilter; s;) { (!i || (r = ue.exec(s))) && (r && (s = s.slice(r[0].length) || s), c.push(o = [])),
                    i = !1,
            ...
            S = t.select = function(e, t, n, i) {
                ...
                if (n = n || [], 1 === d.length) {
                    ...
                    for (r = he.needsContext.test(e) ? 0 : o.length; r--&&(a = o[r], !C.relative[s = a.type]);) if ((c = C.find[s]) && (i = c(a.matches[0].replace(xe, Ce), be.test(o[0].type) && l(t.parentNode) || t))) {
                        if (o.splice(r, 1), e = i.length && f(o), !e) return K.apply(n, i),
                        n;
                        break
                    }
                }
                return (u || _(e, d))(i, t, !j, n, be.test(e) && l(t.parentNode) || t),
                n
            },
        ...
        ce.Callbacks = function(e) {
            e = "string" == typeof e ? ke[e] || u(e) : ce.extend({},
            e);
            var t, n, i, r, o, a, s = [],
            c = !e.once && [],
            l = function(u) {
                for (n = e.memory && u, i = !0, o = a || 0, a = 0, r = s.length, t = !0; s && r > o; o++) if (s[o].apply(u[0], u[1]) === !1 && e.stopOnFalse) {
                    n = !1;
                    break
                }
                t = !1,
                s && (c ? c.length && l(c.shift()) : n ? s = [] : d.disable())
            },
            d = {
                add: function() {
                    if (s) {
                ...
                fireWith: function(e, n) {
                    return ! s || i && !c || (n = n || [], n = [e, n.slice ? n.slice() : n], t ? c.push(n) : l(n)),
                    this
                },
                fire: function() {
        ...
        ce.extend({
            ...
            when: function(e) {
                ...
                if (a > 1) for (t = new Array(a), n = new Array(a), i = new Array(a); a > r; r++) o[r] && ce.isFunction(o[r].promise) ? o[r].promise().done(u(r, i, o)).fail(c.reject).progress(u(r, n, t)) : --s;
        ...
        ce.event = {
            ...
            add: function(e, t, n, i, r) {
                ...
                if (m) {
                    ...
                    l.elem = e), t = (t || "").match(Te) || [""], s = t.length; s--;) o = Pe.exec(t[s]) || [],
                    p = g = o[1],
                    h = (o[2] || "").split(".").sort(),
                    p && (u = ce.event.special[p] || {},
                    p = (r ? u.delegateType: u.bindType) || p, u = ce.event.special[p] || {},
                    d = ce.extend({
                        type: p,
                        origType: g,
                        data: i,
            ...
            remove: function(e, t, n, i, r) {
                ...
                if (m && (l = m.events)) {
                    for (t = (t || "").match(Te) || [""], u = t.length; u--;) if (s = Pe.exec(t[u]) || [], p = g = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (d = ce.event.special[p] || {},
                        p = (i ? d.delegateType: d.bindType) || p, f = l[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), c = o = f.length; o--;) a = f[o],
                    ...
                    } else for (p in l) ce.event.remove(e, p + t[u], n, i, !0);
        ...
        ce.extend({
            clone: function(e, t, n) {
                ...
                if (t) if (n) for (s = s || w(e), i = i || w(o), a = 0; null != (r = s[a]); a++) _(r, i[a]);
                else _(e, o);
                return i = w(o, "script"),
                i.length > 0 && E(i, !c && w(e, "script")),
                i = s = r = null,
                o
            },
            buildFragment: function(e, t, n, i) {
                for (var r, o, a, s, c, u, l, d = e.length,
                f = b(t), p = [], h = 0; d > h; h++) if (o = e[h], o || 0 === o) if ("object" === ce.type(o)) ce.merge(p, o.nodeType ? [o] : o);
                    ...
                    if (!ae.leadingWhitespace && qe.test(o) && p.push(t.createTextNode(qe.exec(o)[0])), !ae.tbody) for (o = "table" !== c || ze.test(o) ? "<table>" !== l[1] || ze.test(o) ? 0 : s: s.firstChild, r = o && o.childNodes.length; r--;) ce.nodeName(u = o.childNodes[r], "tbody") && !u.childNodes.length && o.removeChild(u);
            ...
            cleanData: function(e, t) {
                ...
                c = ce.cache,
                u = ae.deleteExpando,
                l = ce.event.special; null != (n = e[a]); a++) if ((t || ce.acceptData(n)) && (r = n[s], o = r && c[r])) {
                    if (o.events) for (i in o.events) l[i] ? ce.event.remove(n, i) : ce.removeEvent(n, i, o.handle);
        ...
        ce.fn.extend({
            ...
            remove: function(e, t) {
                ...
                n.parentNode && (t && ce.contains(n.ownerDocument, n) && E(w(n, "script")), n.parentNode.removeChild(n));
                return this
            },
            empty: function() {
            ...
            domManip: function(e, t) {
                ...
                if (u && (s = ce.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                    for (o = ce.map(w(s, "script"), T), r = o.length; u > c; c++) i = s,
        ...
        ae.opacity || (ce.cssHooks.opacity = {
            ...
            set: function(e, t) {
                ...
                n.zoom = 1,
                (t >= 1 || "" === t) && "" === ce.trim(o.replace(ut, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || i && !i.filter) || (n.filter = ut.test(o) ? o.replace(ut, r) : o + " " + r)
            }
        }),
        ce.cssHooks.marginRight = L(ae.reliableMarginRight,
        function(e, t) {
            return t ? ce.swap(e, {
        ...
        function(e, t) {
            ce.cssHooks[e + t] = {
                expand: function(n) {
                    for (var i = 0,
                    r = {},
                    o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) r[e + Me[i] + t] = o[i] || o[i - 2] || o[0];
                    return r
                }
            },
        ...
        ce.extend({
            ...
            removeAttr: function(e, t) {
                ...
                ce.expr.match.bool.test(n) ? Lt && At || !It.test(n) ? e[i] = !1 : e[ce.camelCase("default-" + n)] = e[i] = !1 : ce.attr(e, n, ""),
        ...
        _t = {
            set: function(e, t, n) {
                return t === !1 ? ce.removeAttr(e, n) : Lt && At || !It.test(n) ? e.setAttribute(!At && ce.propFix[n] || n, n) : e[ce.camelCase("default-" + n)] = e[n] = !0,
                n
            }
        },
        ...
        ce.fn.extend({
            addClass: function(e) {
                ...
                if (u) for (t = (e || "").match(Te) || []; c > s; s++) if (n = this[s], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace($t, " ") : " ")) {
            ...
            hasClass: function(e) {
                for (var t = " " + e + " ",
                n = 0,
                i = this.length; i > n; n++) if (1 === this[n].nodeType && (" " + this[n].className + " ").replace($t, " ").indexOf(t) >= 0) return ! 0;
                return ! 1
            }
        }),
        ...
        ce.extend({
            ...
            ajax: function(e, t) {
                ...
                t = t || {};
                var i, r, o, a, s, c, u, l, d = ce.ajaxSetup({},
                t),
                f = d.context || d,
                ...
                x = {
                    ...
                    getResponseHeader: function(e) {
                        var t;
                        if (2 === b) {
                            if (!l) for (l = {}; t = Ut.exec(a);) l[t[1].toLowerCase()] = t[2];
                            t = l[e.toLowerCase()]
                        }
        ...
        ce.offset = {
            setOffset: function(e, t, n) {
                ...
                o = ce.css(e, "top"),
                c = ce.css(e, "left"),
                u = ("absolute" === l || "fixed" === l) && ce.inArray("auto", [o, c]) > -1,
                u ? (i = d.position(), a = i.top, r = i.left) : (a = parseFloat(o) || 0, r = parseFloat(c) || 0),
        ...
        ce.each(["top", "left"],
        function(e, t) {
            ce.cssHooks[t] = L(ae.pixelPosition,
            function(e, n) {
            ...
            this.miid && 0 !== this.miid && this.miidLink ? (this.data.userName = this.miid ? $.cookie("XM_" + this.miid + "_UN") : "", this.data.goodsNum = $.cookie("xm_user_www_num"), this.data.goodsNum = null == this.data.goodsNum ? 0 : this.data.goodsNum, null == this.data.userName || "" === this.data.userName ? t.createScript(this.miid) : this.updateDom(this.miid)) : $.ajax({
                ...
                success: function(e) {
                    if (0 === parseInt(e.userId) || null == e.userId) {
                        ...
                        void $("#J_userInfo").find(".link[data-needlogin]").attr("href", n)
                    }
                    var i = {
                        path: "/",
                        domain: ".mi.com"
            ...
            for (var i = [], r = t; n > r;) {
                ...
                if (n >= r + s) {
                    ...
                    case 3:
                        c = e[r + 1],
                        u = e[r + 2],
                        128 === (192 & c) && 128 === (192 & u) && (d = (15 & o) << 12 | (63 & c) << 6 | 63 & u, d > 2047 && (55296 > d || d > 57343) && (a = d));
                        break;
                    case 4:
                        c = e[r + 1],
                        u = e[r + 2],
                        l = e[r + 3],
                        128 === (192 & c) && 128 === (192 & u) && 128 === (192 & l) && (d = (15 & o) << 18 | (63 & c) << 12 | (63 & u) << 6 | 63 & l, d > 65535 && 1114112 > d && (a = d))
                    }
                }
...
function(e, t, n) {
    ...
    function(e) {
        ...
        function n(e) {
            ...
            var l = e.length;
            c = "=" === e.charAt(l - 2) ? 2 : "=" === e.charAt(l - 1) ? 1 : 0,
            u = new o(3 * e.length / 4 - c),
...
function(e, t) { !
    function(e) {
        function t(t) {
            ...
            function i() {
                g && clearTimeout(g),
                l.exitMenu(this) && (f && l.deactivate(f), f = null)
            }
            function r() {
                g && clearTimeout(g),
                l.enter(this),
            ...
            l = e.extend({},
            u, t),
            d.on("mouseleave", i).find(l.rowSelector).on({
                mouseenter: r,
                mouseleave: o,
                click: function() {
                    a(this)
...
function(e, t) { !
    function(e) {
        function t(e) {
            ...
            i = e.length; i > n; n += 1) {
                var r, o;
                "object" == typeof e[n] ? (r = e[n].Key.replace(f, '<span class="keyword">' + f + "</span> "), o = e[n].Rst ? '<span class="result">约有' + e[n].Rst + "件</span>": "", t += '<li data-key="' + e[n].Key + '"><a href="/search_' + encodeURIComponent(e[n].Key) + '">' + r + o + "</a></li>") : (r = e[n].replace(f, '<span class="keyword">' + f + "</span> "), o = "", t += '<li data-key="' + e[n] + '"><a href="//search.mi.com/search_' + encodeURIComponent(e[n]) + '">' + r + o + "</a></li>")
            }
        ...
        a.length && (c = a.find("#search"), l = e.parseJSON(c.data("search-config").replace(/'/g, '"')), a.append(s), c.on({
            focus: function() {
                ...
                !e(this).val() && l.defaultWords && t(l.defaultWords)
            },
            blur: function() {
            ...
            keyup: function(i) {
                0 === e.trim(e(this).val()).length && l.defaultWords && (f = null, t(l.defaultWords)),
                n(i.which),
                clearTimeout(h),
...
function(e, t, n) {
    ...
    MI.bigtap = {
        init: function(e) {
            ...
            t.inTheQueue = !1,
            $.extend(t.config, e),
            t.config.modeType ? t.checkShowMode() : t.getHdInfo(),
            $("#J_bigtapRetry").off().on("click",
            function() {
                t.startQueue(),
                t.getHdget()
            }),
...
function(e, t) {
	...
	<div  class="modal modal-hide fade modal-user-risk" id="J_modalUserRisk">
	    <div class="modal-hd">
	        ...
	        <a class="close" data-dismiss="modal" href="javascript: void(0);"><i class="iconfont">&#xe602;</i></a></div>
	    <div class="modal-bd">
	        ...
	        <div class="form-section">
	            ...
	            <span href="javascript:void(0);" class="btn btn-coutdown hide" id="J_riskCoutdown"></span></div>
	        <div class="tip-msg" id="J_riskTipMsg"></div></div>
	    <div class="modal-ft">
	        <a class="btn btn-gray" data-dismiss="modal" href="javascript: void(0);">取消</a>
	        <a class="btn btn-primary" href="javascript: void(0);" id="J_submitRiskCode">提交</a></div>
	</div>
	  */
                console.log()
            })
	...
	<div  class="modal modal-hide fade modal-user-risk" id="J_modalUserRisk">
	    ...
	    <div class="modal-bd">
	        ...
	        <a href="https://account.xiaomi.com/pass/auth/security/home" class="btn btn-primary " id="J_riskPortalLink" target="_blank">前往小米账号中心</a></div>
	</div>
	  */
                console.log()
            })
